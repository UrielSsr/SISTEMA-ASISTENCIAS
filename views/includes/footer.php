          ...
          <div class="card">
            <div class="card-body">
              <div class="d-sm-flex justify-content-center justify-content-sm-between py-2">
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Sistema de Asistencia<a href="" target="_blank"> </a>2025</span>
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Github-UrielSsr<a href="" target="_blank"></a></span>
              </div>
            </div>
          </div>
        </footer>
